...
def main():
    ...
    # print("cfg['data']['test']['ann_file']=",cfg['data']['test']['ann_file'])
    # cfg['data']['val']['ann_file'] = args.ann
    ...
    if rank == 0:
        ...
        if eval_config:
            ...
            # res = {}
            # ann_file = args.ann
            # id = ann_file.split("/")[-1].split(".")[0]
            # res['id'] = id
            # # ann_test_path = id + ".json"
            ...
            # dest = os.path.join(output_dir,result_file_name)
            # res['ann_file'] = args.ann

            # with open(dest,'a',encoding="utf-8") as file:
            #     s = f"{res['id']} {res['top1_acc']} {res['top5_acc']} {res['mean_class_accuracy']} {res['ann_file']}\n"
            #     file.write(s)
