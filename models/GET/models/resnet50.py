...
class Classifier(nn.Module):
    def __init__(self,
                #  voxel_dimension=(9,180,240), 
                 voxel_dimension=(9,240,320),  # dimension of voxel will be C x 2 x H x W (180, 240)
    ...
    def forward(self, x):
        ...
        #     # 使用 json.dump 将值写入 JSON 文件
        #     json.dump(pred.cpu().numpy().tolist(), json_file)

        # print(f'pred:{pred} predshape:{pred.shape}')
        return pred, vox
